...
func main() {
	...
	select_db(db, 2500, 60000)
	escribir_db(db, 10000)
	select_db(db, 2500, 70000)
	escribir_db(db, 10000)
	select_db(db, 2500, 80000)
	escribir_db(db, 10000)
	select_db(db, 2500, 90000)
	escribir_db(db, 10000)
	select_db(db, 2500, 100000)
	escribir_db(db, 10000)
	select_db(db, 2500, 110000)
	escribir_db(db, 10000)
	select_db(db, 2500, 120000)
	escribir_db(db, 10000)
	select_db(db, 2500, 130000)
	escribir_db(db, 10000)
	select_db(db, 2500, 140000)
	escribir_db(db, 10000)
